...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">Soporte || DATAZUCAR</a>
        ...
        <!--EN LAS VISTAS DONDE NO USE GROCERY DEBO CARGAR JQUERY MANUALMENTE-->
