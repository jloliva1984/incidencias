...
class Subsistemas extends BaseController
{
    ...
    // public function sistemas_management()
	// {
    //     $crud = new GroceryCrud();

	//     $crud->setTable('sistemas');

    //     $output = $crud->render();
        
    //     return view('sistemas_view', (array)$output);

	// 	//return $this->_exampleOutput($output);
    // }

    public function subsistemas_management()
	{
        $crud = new GroceryCrud();

        $crud->setTable('subsistemas');
        $crud->setSubject('Subsistema');
        $crud->setRelation('id_sistema','sistemas','nombre');
        $crud->displayAs('id_sistema','Sistema');
        $crud->setRead();
    ...
    private function _exampleOutput($output = null) {
        return view('subsistemas_view', (array)$output);
    }
}